...
export class BarChartComponent {
  ...
  downloadChartAsImage() {
    ...
    downloadChartAsPNG(this.chart, 'bar');
  }
  ...
  data: ChartDataset<'bar'>[] = [
    {
      ...
      borderWidth: 1,
      // hoverBackgroundColor: 'rgba(255, 99, 132, 0.8)',  // highlight color on hover
      // hoverBorderColor: 'rgba(255, 99, 132, 1)',
      borderRadius: 6, // rounded bars for softer look
      maxBarThickness: 50, // max width of bars
    },
  ];
